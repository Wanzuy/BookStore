...
const About = () => {
    return <>
        ...
        <div className="px-4 lg:px-24">
            <div >
                <h1 className="font-bold text-[30px] text-[#ED553B]">About Us</h1>
                <p className="mt-[44px] text-[20px] text-justify italic">Welcome to Neth BookPoint, your trusted source for a diverse range of books catering to every reader's taste. Established with the mission to foster a love for reading in our community, we pride ourselves on providing excellent service and a wide selection of books. Our journey began in 2021, and since then, we have grown to become a beloved destination for book lovers. Below, you'll find information about our four branches, their locations, and contact numbers.</p>
            </div>

            <div className="mt-[66px]">
                <h1 className="font-bold text-[30px] text-[#ED553B]">Our Branches</h1>
                <div className="mt-[47px] flex gap-24">
                    {/* Branch 1 */}
                    <div className=" p-6 rounded-lg shadow-lg text-center">
                        <h3 className="text-xl font-semibold text-[#ED553B]">Kurunegala</h3>
                        <p className="mt-2">
                            <span className="text-[#F27A61]"> Main Street, City Center</span><br />
                            Contact: 011-2345678 <br />
                            Operating Hours: Monday to Saturday - 9 AM - 7 PM
                        </p>
                        <p className="mt-4 italic">
                            In-store shopping, Special sessions for children, Workshops, Study
                            space
                        </p>
                    </div>
                    ...
                    {/* Branch 2 */}
                    <div className=" p-6 rounded-lg shadow-lg text-center">
                        <h3 className="text-xl font-semibold text-[#ED553B]">Kandy</h3>
                        <p className="mt-2">
                            <span className="text-[#F27A61]"> Main Street, City Center</span><br />
                            Contact: 011-2345678 <br />
                            Operating Hours: Monday to Saturday - 9 AM - 7 PM
                    ...
                    {/* Branch 3 */}
                    <div className=" p-6 rounded-lg shadow-lg text-center">
                        <h3 className="text-xl font-semibold text-[#ED553B]">Colombo</h3>
                        <p className="mt-2">
                            <span className="text-[#F27A61]"> Main Street, City Center</span><br />
                            Contact: 011-2345678 <br />
                            Operating Hours: Monday to Saturday - 9 AM - 7 PM
