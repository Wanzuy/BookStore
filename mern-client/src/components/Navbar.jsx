...
const Navbar = () => {
    ...
    const userMenu = (
        <Menu className="!shadow-2xl !p-6">
            <div className="flex items-center gap-3">
                <Avatar
                    className="bg-[#ff6465] hover:cursor-pointer"
                    shape="square"
                    size={50}
                    icon={<UserOutlined />}
                />
            ...
            <ul className="mt-7">
                {user?.role === "user" && (
                    <li>
                        <Link
                            className="py-3 block hover:text-black text-[16px]"
                            to="/user/acount"
                        >
                            Hồ sơ
                        </Link>
                ...
                <li className=" border-t ">
                    <Link
                        className="flex justify-between items-center py-3 hover:text-black text-[16px]"
                        to="#"
                    >
                        Chế độ tối <SunOutlined />
                    </Link>
                </li>
                <li>
                    <Link
                ...
                <li className="border-t">
                    <span
                        className="py-3 block hover:text-black cursor-pointer text-[16px]"
    ...
    return (
        <header className="w-full bg-[#ffffff]">
            <nav
                className={`bg-[#ffffff] pb-3 xl:px-24 px-4 ${
                    isSticky
                        ...
                        <ul className="hidden lg:flex space-x-8">
                            {navItems.map(({ link, path }) => (
                                <Link
                                    key={path}
                                    to={path}
                                    className={`block text-[14px] text-base font-semibold uppercase cursor-pointer hover:text-[#ff6465] hover:border-b-4 hover:border-[#ff6465] ${
